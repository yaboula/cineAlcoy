        ...
        <div className="px-4 md:px-0 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              disabled={isLoadingEpisodes}
              className="bg-surface border border-border rounded-lg px-3 py-2 text-sm text-text-primary focus:outline-none focus:border-accent-primary/60 disabled:opacity-50"
            >
              {displaySeasons.map((s) => (
              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded-lg transition-all text-sm ${
                    isActive
                      ? "bg-accent-primary/20 border-l-2 border-accent-primary text-text-primary"
                      : "hover:bg-surface text-text-secondary hover:text-text-primary border-l-2 border-transparent"
                  }`}
                >
                  <span className="font-medium text-text-muted mr-2 text-xs">
                    E{ep.episode_number}
                  </span>
